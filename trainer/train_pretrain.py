...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/pretrain_t2t_mini.jsonl", help="Pretrain data path")
    parser.add_argument('--from_weight', default='none', type=str, help="Which weight to train from; 'none' means start from scratch")
